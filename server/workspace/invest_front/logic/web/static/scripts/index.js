...
$(function(){
	$("#kinMaxShow").kinMaxShow({
        ...
        button:{
            ...
            normal:{background:'url(http://www.hytz.com/statics/images/hy/button.png) no-repeat -14px 0',marginRight:'8px',border:'0',right:'44%',bottom:'20px'},
            //当前焦点图按钮样式 设置，写法同上
            focus:{background:'url(http://www.hytz.com/statics/images/hy/button.png) no-repeat 0 0',border:'0'}
        }
