...
from utils.interfaces.openfire.user_service import UserService
from utils.interfaces.openfire.jid import JidMgr
...
class XMPPClient(EventHandler, XMPPFeatureHandler):
    ...
    def handle_disconnected(self, event):
        ...
        logger.error("XMPPClient::handle_disconnected: JID:%s!!!" % self.JID)
        return QUIT
    ...
    def handle_presence_available(self, stanza):
        ...
        :return:
        """
        logger.info("XMPPClient::handle_presence_available: %s available notify to %s" % (stanza.from_jid, stanza.to_jid))
        return True
    ...
    def handle_presence_unavailable(self, stanza):
        ...
        :return:
        """
        logger.info("XMPPClient::handle_presence_unavailable: %s unavailable notify to %s" % (stanza.from_jid, stanza.to_jid))
        return True
    ...
    def handle_presence_subscribed(self, stanza):
        ...
        :return:
        """
        logger.info("XMPPClient::handle_presence_subscribed: %s accepted %s subscription request" % (stanza.from_jid, stanza.to_jid))
        return True
    ...
    def handle_presence_unsubscribed(self, stanza):
        ...
        :return:
        """
        logger.info("XMPPClient::handle_presence_unsubscribed: %s acknowledged %s subscription cancelation" % (stanza.from_jid, stanza.to_jid))
        return True
    ...
    def add_roster(self, Jid, name=None, groups=None):
        ...
        # 用userservice 的add roster则没有handle_presence_available通知
